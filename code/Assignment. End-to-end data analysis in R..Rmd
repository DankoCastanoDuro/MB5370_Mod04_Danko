...
file_path <- file.path("C:/Users/Danko Castaño Duro/Desktop/Australia 3 semestre/Modulos 1/INTRODUCTION TO R 4/MB5370_Mod04_Danko/MB5370_Mod04_Danko", "shark.csv")

shark <- read_csv(file_path)
...
```{r}
just_shark_Townsville <- shark_cleaned %>% filter(Area == "Townsville" & SpeciesGroup == "Shark")
...
ggplot(just_shark_Townsville, aes(x = CalendarYear), y = NumberCaught_Total, color = SpeciesGroup) +
  geom_boxplot() +
  labs(title = "Shark Areas by Year Townsville", x = "Year", y = "Area") +
  theme_minimal()
